package com.youwu.shopowner.utils;

import android.content.Context;
import android.text.TextUtils;

import com.youwu.shopowner.BuildConfig;
...
public class RetrofitClient {
    ...
    //服务端根路径
    public static String baseUrl = "https://saas_test_api_v1.youwuu.com/app/";//测试 20022-08-09
                ...
                .addInterceptor(new Interceptor() {
                    ...
                    public Response intercept(Chain chain) throws IOException {
                        Request.Builder builder = chain.request().newBuilder()
                                .header("Authorization", UserUtils.getTokenType()+" "+UserUtils.getToken());
